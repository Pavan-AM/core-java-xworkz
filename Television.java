class Television{
	...
	System.out.println("Television name is :" + name);
	System.out.println("Invoking onOrOff");
	System.out.println("Parameter"+ 0);
	if(isConnected==false){
	  isConnected=true;
	  System.out.println("the Television  on...");
	}else if(isConnected==true){
	isConnected=false;
	System.out.println("the Television off...");
	...
	System.out.println("Parameter"+ 2);
		 ...
		 if(isConnected==true){
			 ...
			 System.out.println("Television connect maadu firstu");
